        ...
        <div className="my-8">
          ...
          {download && typeof download === "object" && (
            <Link
              ...
              role="button"
              className={`lowercase inline-block whitespace-nowrap w-fit border border-1 border-white pb-2 pt-3 px-8 text-xl bg-black text-white hover:bg-white hover:text-black`}
              download={true}
              target="_blank"
